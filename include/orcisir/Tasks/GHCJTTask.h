...
public:
    ...
    //------------------------ friendship ------------------------//
protected:
    friend class GHCJTController;    //Only the ISIRController should know about the following functions
    void connectToController(ISIRSolver& _solver, SumOfLinearFunctions& seConstraint, bool useGSHC);
