 ...
 *
 * Concrete instances are orcisir::OneLevelSolverWithQuadProg and orcisir::OneLevelSolverWithQLD .
 */
class OneLevelSolver: public ISIRSolver
{
public:
    OneLevelSolver();
    virtual ~OneLevelSolver();

    virtual void setObjectiveLevel(orc::QuadraticObjective& obj, int level);
