 ...
 *
 * \brief Define joint limit constraint for ISIR controller.
 */
 ...
 *
 * See \ref orcisir::JointLimitFunction ofr more information.
 */
class FullJointLimitFunction: public JointLimitFunction
{
    public:
        ...
        FullJointLimitFunction(const orc::Model& model);
...
class ReducedJointLimitFunction: public JointLimitFunction
{
    public:
        ...
        ReducedJointLimitFunction(const orc::Model& model, const ISIRDynamicFunction& dynamicEquation);
...
class JointLimitConstraint: public ISIRConstraint
{
public:
    JointLimitConstraint(const orc::Model& model, double hpos=.2);
    JointLimitConstraint(const orc::Model& model, const Eigen::VectorXd& lowerLimits, const Eigen::VectorXd& upperLimits, double hpos=.2);
...
private:
    JointLimitFunction* createFullJointLimitFunction(const orc::Model& model);
    JointLimitFunction* createReducedJointLimitFunction(const orc::Model& model, const ISIRDynamicFunction& dynamicEquation);
