...
int main(int argc, char** argv)
{
    ...
    icubfixed*                             model;
    model = new icubfixed("icub");

    orcisir::OneLevelSolverWithQuadProg   solver;

    orcisir::GHCJTController               ctrl("myCtrl", *model, solver, useReducedProblem, useGSHC);
...
//================ FULL STATE ==============================================================================//
    ...
    accTask->setStiffness(1);
    accTask->setDamping(0.01);
...
//================ FRAME ==============================================================================//
    ...
    TF->setPosition(Eigen::Displacementd(0.2,0.2,0.3));
    ...
    accTask2->setStiffness(30);
    accTask2->setDamping(10);
...
//================ FRAME2 ==============================================================================//
    ...
    feat3 = new orc::PositionFeature("frame2", *SF2, orc::XYZ);
    orc::PositionFeature* featDes3;
    featDes3 = new orc::PositionFeature("frame2.Des", *TF2, orc::XYZ);

    TF2->setPosition(Eigen::Displacementd(0.2,-0.12,0.057));
    ...
    accTask3->setStiffness(30);
    accTask3->setDamping(18);
