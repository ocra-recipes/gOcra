...
//================ FRAME ==============================================================================//
    orc::SegmentFrame        SF("frame.SFrame", model, "icub.r_hand", Eigen::Displacementd());
...
//================ FRAME2 ==============================================================================//
    orc::SegmentFrame        SF2("frame2.SFrame", model, "icub.l_hand", Eigen::Displacementd());
    ...
    TF2.setPosition(Eigen::Displacementd(-0.2,0.3,0.4));
