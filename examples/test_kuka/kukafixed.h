...
#ifndef _kukafixed_H_
#define _kukafixed_H_

#include "orc/control/Model.h"


class kukafixed: public orc::Model
{
public:
    //================ General Methods =================//
    ...
    kukafixed(const std::string& robotName);
    virtual ~kukafixed();
...
//extern "C"
//{
//    orc::Model* Create_kukafixed(const std::string& robotName)
//    {
//        return new kukafixed(robotName);
//    }
