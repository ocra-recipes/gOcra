 ...
 *
 * \brief Implement the internal solver class that can be used in the ISIR controller.
 */
 ...
 *
 */
ISIRSolver::ISIRSolver()
    : orc::Solver()
    , orc::NamedInstance("ISIR Solver")
{
 ...
 */
void ISIRSolver::printValuesAtSolution()
{
 ...
 * Actually does nothing.
 */
std::string ISIRSolver::toString() const
{
 ...
 */
void ISIRSolver::addObjective(orc::QuadraticObjective& obj)
{
 ...
 */
void ISIRSolver::removeObjective(orc::QuadraticObjective& obj)
{
 ...
 */
void ISIRSolver::addConstraint(orc::LinearConstraint& constraint)
{
 ...
 */
void ISIRSolver::removeConstraint(orc::LinearConstraint& constraint)
{
 ...
 *
 */
void ISIRSolver::prepareMatrices()
{
    Xsolution.resize(n());
}
 ...
 *  - solver_solve
 */
void ISIRSolver::writePerformanceInStream(std::ostream& outstream, bool addCommaAtEnd)
{
 ...
 *
 */
void ISIRSolver::reduceConstraints(const Eigen::MatrixXd& A, const Eigen::VectorXd& b, Eigen::MatrixXd& Ar, Eigen::VectorXd& br, double tolerance)
{
    if (A.rows()>0)
    {
